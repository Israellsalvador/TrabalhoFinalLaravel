...
@section('title', 'Adicionar Livro - Biblioteca')

@section('conteudo')
<h2 style="margin-bottom: 20px;">Adicionar Novo Livro</h2>

<form method="POST" action="/livros" enctype="multipart/form-data" style="max-width: 600px;">
    @csrf
    ...
    <div style="margin-bottom: 15px;">
        ...
        <textarea name="descricao" required style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 4px; min-height: 100px;">{{ old('descricao') }}</textarea>
    ...
    <div style="margin-bottom: 15px;">
        ...
        <input type="number" name="ano" required value="{{ old('ano') }}" 
               style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 4px;">
